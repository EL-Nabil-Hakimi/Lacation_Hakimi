              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <form id="photoForm" method="post" enctype="multipart/form-data" action="changephotomanager/<?php echo e($user[0]->manager->id); ?>">
                        <?php echo csrf_field(); ?>
                        <label for="fileToUpload">
                            <div class="profile-pic" style="background-image: url('<?php echo e($user[0]->manager->image); ?>')">
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YouCode\Documents\Mes Projets\fileRouge\Location_Hakimi\resources\views/admin/layout/profile.blade.php ENDPATH**/ ?>