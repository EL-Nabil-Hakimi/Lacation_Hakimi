              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <form id="photoForm" method="post" enctype="multipart/form-data" action="/manager/changeimage/<?php echo e($user[0]->manager->id); ?>">
                        <?php echo csrf_field(); ?>
                        <label for="fileToUpload">
                            <div class="profile-pic" style="background-image: url('<?php echo e(asset($user[0]->manager->image)); ?>')">
                     ...
                     <div class="mt-3">
                      <h4><?php echo e($user[0]->manager->nom); ?> <?php echo e($user[0]->manager->prenom); ?></h4>
                      <p class="text-secondary mb-4"><?php echo e($user[0]->role->name); ?></p>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php echo e($user[0]->manager->nom); ?> <?php echo e($user[0]->manager->prenom); ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <?php echo e($user[0]->manager->phone); ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <?php echo e($user[0]->manager->adresse); ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YouCode\Documents\Mes Projets\fileRouge\Location_Hakimi\resources\views/admin/layout/profile-manager.blade.php ENDPATH**/ ?>