...
<div class="card">
    ...
    <div id="acceptation">
        <?php if($car->accepte == 0): ?>
            <div style="background-color:rgb(1, 1, 162)">En attente</div>
        <?php elseif($car->accepte == 1): ?>
            <div style="background-color:rgb(5, 116, 18)">Accepté</div>
        <?php elseif($car->accepte == 3): ?>
            <div style="background-color:rgb(197, 215, 39)">Car is out</div>
        <?php elseif($car->accepte == 2): ?>
            <div style="background-color:rgb(180, 13, 13)">Rejeté</div>
        <?php endif; ?>
    </div>

    <img class="card__image" src="<?php echo e(asset('images/cars/'.$car->image)); ?>" />
    <main class="card__content">
            <p  class="price_car"><?php echo e($car->prix_par_jour); ?> <span>Dh/j</span></p>
            ...
            <i class="fas fa-edit text-primary" id="btnedit" onclick="modifier_car(
                        '<?php echo e($car->id); ?>',
                        '<?php echo e(asset('images/cars/'.$car->image)); ?>',
                        '<?php echo e($car->matricule); ?>', 
                        '<?php echo e($car->marque->id); ?>',
                        '<?php echo e($car->model->id); ?>',
                            '<?php echo e($car->description); ?>',
                            '<?php echo e($car->transmission); ?>',
                            '<?php echo e($car->capacite_coffre); ?>',
                            '<?php echo e($car->type_carburant); ?>',
                                '<?php echo e($car->nombre_de_sieges); ?>',
                                '<?php echo e($car->prix_par_jour); ?>',)">
            </i>
            <a class="text-danger" onclick="Modals(<?php echo e($car->id); ?> , 'Confirmer la rendue indisponible' , 'Êtes-vous sûr de vouloir rendre cette voiture indisponible ?' , 'warning' , '/cars/indesponible/')" title="Indisponible"><i class="fas fa-ban"></i></a>
            <a class="text-success" onclick="Modals(<?php echo e($car->id); ?> , 'Confirmer la rendue disponible' , 'Êtes-vous sûr de vouloir rendre cette voiture disponible ?' , 'warning' , '/cars/desponible/' )" title="Disponible"><i class="fas fa-check"></i></a>
            <?php if($car->accepte == null && session()->get('role_id') == 1): ?>
                <a class="text-success" onclick="Modals(<?php echo e($car->id); ?> , 'Confirmer l\'acceptation' , 'Êtes-vous sûr d\'accepter cette voiture' ,'warning', '/admin/cars/restore/')" title="Accepter"><i class="bi bi-check-square-fill"></i> </a>
                <a class="text-danger" onclick="Modals(<?php echo e($car->id); ?> ,'Confirmer le rejet' , 'Êtes-vous sûr de rejeter cette voiture' , 'warning' ,'/admin/cars/destroy/')" title="Rejeter">  <i class="bi bi-x-square-fill"></i> </a>
            <?php endif; ?>
            <?php if(session()->get('role_id') == 1): ?>
                <a class="text-danger" onclick="Modals(<?php echo e($car->id); ?> , 'Confirmer la suppression' , 'Êtes-vous sûr de vouloir supprimer cette voiture ?' , 'error' , '/admin/cars/delete/')" title="Supprimer"><i class="fas fa-trash"></i></a>
            <?php endif; ?>  

       </div>
        <h1 class="card__head"><?php echo e($car->marque->name); ?></h1>
       <span class="card__date">Module: <?php echo e($car->model->name); ?></span>
    <p class="card__text"> <?php echo e($car->description); ?></p>
    <div class="row">
        <div class="col-md-6">
            <p class="card__text"><i class="fas fa-car"></i> <span class="small"><?php echo e($car->transmission); ?></span></p>
            <p class="card__text"><i class="fas fa-suitcase"></i> <span class="small"><?php echo e($car->capacite_coffre); ?></span></p>
        </div>
        <div class="col-md-6">
            <p class="card__text"><i class="fas fa-gas-pump"></i> <span class="small"><?php echo e($car->type_carburant); ?></span></p>
            <p class="card__text"><i class="fas fa-chair"></i> <span class="small"><?php echo e($car->nombre_de_sieges); ?></span></p>
        </div>
    </div>
    
    
     
       <?php if($car->disponibilite == 1): ?>
       ...
       <?php else: ?>
        ...
        <?php endif; ?>
        <small class="card__tag mb-2"><?php echo e($car->matricule); ?></small>
...
<div class="liksbtns"><?php echo e($cars->links('pagination::bootstrap-5')); ?></div>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YouCode\Documents\Mes Projets\fileRouge\Location_Hakimi\resources\views/admin/layout/cars/cars-manager.blade.php ENDPATH**/ ?>