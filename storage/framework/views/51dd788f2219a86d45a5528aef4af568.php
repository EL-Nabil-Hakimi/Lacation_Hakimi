...
<table class="table align-middle mb-0 mt-5 bg-white"  >
    ...
    <tbody>
        ...
        <?php $__currentLoopData = $marques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $marque): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            
          <tr>
            ...
            <td>
              <button onclick="openUpdateModal(<?php echo e($marque->id); ?> , '<?php echo e($marque->name); ?>')" type="button" class="btn btn-link btn-sm btn-rounded">
                <i class="fas fa-edit"></i>
              </button>

              <button onclick="popupdelmanager(<?php echo e($marque->id); ?>)" type="button" class="btn btn-link btn-sm btn-rounded" style="color: red">
  ...
  <div class="liksbtns"><?php echo e($marques->links('pagination::bootstrap-5')); ?></div>
</div>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YouCode\Documents\Mes Projets\fileRouge\Location_Hakimi\resources\views/admin/layout/cars/cars-marque.blade.php ENDPATH**/ ?>