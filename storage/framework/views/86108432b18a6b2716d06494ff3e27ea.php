          ...
          <div class="row align-items-center">
            <div class="col-lg-5">
              <div class="feature-car-rent-box-1">
                  <h3>Login</h3>
                <form class="feature-list" action="/signin" method="POST">
                  <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" id="password" name="password" class="form-control border-bottom" required>
                    </div>
                        <div class="form-group">
                          <button type="submit" style="width: 100%" class="btn btn-primary">Login</button>
                          <a href="<?php echo e(route('Auth.register')); ?>" class="mt-1 d-block text-center" style="width: 100%;">Dont have account?</a>
...
<?php /**PATH C:\Users\YouCode\Documents\Mes Projets\Location_Hakimi\resources\views/Auth/login.blade.php ENDPATH**/ ?>