          ...
          <div class="row align-items-center">
            <div class="col-lg-5">
              <div class="feature-car-rent-box-1">
                  <h3>Email</h3>
                <form class="feature-list" action="/checkemail" method="POST">
                  <?php echo csrf_field(); ?>
                    <div class="form-group">
                      <label for="username">Email:</label>
                      <input type="mail" id="username" name="email" class="form-control border-bottom"  required>
                    </div>                    
                        <div class="form-group">
                          <button type="submit" style="width: 100%" class="btn btn-primary">Send email</button>
...
<?php /**PATH C:\Users\YouCode\Documents\Mes Projets\Location_Hakimi\resources\views/Auth/email.blade.php ENDPATH**/ ?>