            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class="active"><a href="<?php echo e(route('Client.about')); ?>" class="nav-link">About</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0 order-lg-2">
            <img src="assets/Client/images/hero_2.jpg" alt="Image" class="img-fluid">
          </div>
        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1">
                ...
                <img src="assets/Client/images/person_2.jpg" alt="Image"
                 class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1">
                ...
                <img src="assets/Client/images/person_3.jpg" alt="Image"
                 class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1">
                ...
                <img src="assets/Client/images/person_4.jpg" alt="Image"
                 class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1">
                ...
                <img src="assets/Client/images/person_5.jpg" alt="Image"
                 class="img-fluid">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <img src="assets/Client/images/hero_1.jpg" alt="Image" class="img-fluid">
          </div>
...
<?php /**PATH C:\xampp\htdocs\Location_Hakimi\resources\views/Client/about.blade.php ENDPATH**/ ?>