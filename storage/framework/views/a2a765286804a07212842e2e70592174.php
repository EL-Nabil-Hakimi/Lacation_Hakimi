            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class="active"><a href="<?php echo e(route('Client.contact')); ?>" class="nav-link">Contact</a></li>
                </ul>
              </nav>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Location_Hakimi\resources\views/Client/contact.blade.php ENDPATH**/ ?>