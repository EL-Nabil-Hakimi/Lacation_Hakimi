...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li><a href="<?php echo e(route('Client.index')); ?>" class="nav-link">Home</a></li>
                  <li><a href="<?php echo e(route('Client.services')); ?>" class="nav-link">Services</a></li>
                  <li><a href="<?php echo e(route('Client.cars')); ?>" class="nav-link">Cars</a></li>
                  <li><a href="<?php echo e(route('Client.about')); ?>" class="nav-link">About</a></li>
                  <li><a href="<?php echo e(route('Client.blog')); ?>" class="nav-link">Blog</a></li>
                  <li><a href="<?php echo e(route('Client.contact')); ?>" class="nav-link">Contact</a></li>
                </ul>
              </nav>
            </div>
    ...
    <div class="ftco-blocks-cover-1">
      <div class="ftco-cover-1 innerpage overlay" style="background-image: url('assets/Client/images/hero_2.jpg')">
        <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            ...
            <div class="pt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="assets/Client/images/person_2.jpg" alt="Free Website Template by Free-Template.co">
                  </div>
                ...
                <li class="comment">
                  <div class="vcard bio">
                    <img src="assets/Client/images/person_3.jpg" alt="Free Website Template by Free-Template.co">
                  </div>
                  <div class="comment-body">
                    <h3>Chris Meyer</h3>
                    <div class="meta">January 9, 2018 at 2:21pm</div>
                  ...
                  <ul class="children">
                    <li class="comment">
                      <div class="vcard bio">
                        <img src="assets/Client/images/person_5.jpg" alt="Free Website Template by Free-Template.co">
                      </div>
                      <div class="comment-body">
                        <h3>Chintan Patel</h3>
                        <div class="meta">January 9, 2018 at 2:21pm</div>
                      ...
                      <ul class="children">
                        <li class="comment">
                          <div class="vcard bio">
                            <img src="assets/Client/images/person_1.jpg" alt="Free Website Template by Free-Template.co">
                          </div>
                          <div class="comment-body">
                            <h3>Jean Doe</h3>
                            <div class="meta">January 9, 2018 at 2:21pm</div>
                            ...
                            <ul class="children">
                              <li class="comment">
                                <div class="vcard bio">
                                  <img src="assets/Client/images/person_4.jpg" alt="Free Website Template by Free-Template.co">
                                </div>
                                <div class="comment-body">
                                  <h3>Ben Afflick</h3>
                                  <div class="meta">January 9, 2018 at 2:21pm</div>
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box">
              <img src="assets/Client/images/person_1.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid mb-4 w-50 rounded-circle">
...
<?php /**PATH C:\xampp\htdocs\Location_Hakimi\resources\views/Client/single.blade.php ENDPATH**/ ?>