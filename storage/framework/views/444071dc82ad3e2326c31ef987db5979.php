        ...
        <div class="container mt-5 mb-5">
          ...
          <div class="d-flex justify-content-center row mt-3" >
            <div class="col-md-10" style="box-shadow: 0px 0px 5px 1px">
              <p id="idreservation">Invoice number : <?php echo e($res->id); ?></p>
              <hr>
                ...
                <div class="row p-2 bg-white " style="align-items: center">
                    ...
                    <div class="col-md-6 mt-1">
                        ...
                        <h5><?php echo e($res->car->marque->name); ?> <h6><?php echo e($res->car->model->name); ?></h6></h5>
                    ...
                    <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                        ...
                        <div class="d-flex flex-column mt-4">
                          ...
                          <button class="btn btn-danger btn-sm" type="button" onclick="AlertCan( '<?php echo e($res->id); ?>' ,'5','If this reservation is canceled, you can\'t cancel it again.')">
                            <i class="fas fa-times"></i> Cancel
                          </button>
                          <?php elseif($res->accepte == 1 || $res->accepte == 2): ?>
                          <button class="btn btn-danger btn-sm" type="button" onclick="AlertCant('This reservation cannot be canceled.')">
                            <i class="fas fa-times"></i> Cancel
                          </button>
                          <?php elseif($res->accepte == 3 || $res->accepte == 4): ?>
                          ...
                          <?php elseif($res->accepte == 1): ?>
                            <button class="btn btn-outline-primary btn-sm mt-2" type="button" onclick="downloadReservation(<?php echo e($res->id); ?>)">
                              <i class="fas fa-download"></i> Download
                            </button>
                          <?php elseif($res->accepte == 2): ?>
