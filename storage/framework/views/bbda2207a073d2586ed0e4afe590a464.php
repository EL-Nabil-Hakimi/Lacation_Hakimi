    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        ...
        <div class="card shadow-sm ">
            ...
            <?php if($infos[0]->client->accepte == null  ): ?>
            <li class="nav-item d-flex justify-content-end p-2">
              <button class="btn" onclick="openComfirmModalinfo(<?php echo e($infos[0]->client->id); ?>)" title="Je confirme que cette personne est réelle et que les informations fournies sont correctes?">
              ...
              <button class="btn" onclick="openCancelConfirmationModal(<?php echo e($infos[0]->client->id); ?>)" title="Je ne suis pas sûr">
                  <i class="far fa-square fa-lg"></i>  
                  <span style="color: white">Infirmer</span>
              </button>
                  </li>
            <?php elseif($infos[0]->client->accepte == 1): ?>
            <li class="nav-item d-flex justify-content-end p-2">
              <button class="btn" onclick="openComfirmModalinfo(<?php echo e($infos[0]->client->id); ?>)" title="Je confirme que cette personne est réelle et que les informations fournies sont correctes?">
          ...
          <div class="card-header bg-transparent text-center">
            <form id="photoForm" method="post" enctype="multipart/form-data" action="/changephotouser/<?php echo e($infos[0]->client->id); ?>">
              <?php echo csrf_field(); ?>
              <label for="fileToUpload">
                  <div class="profile-pic" style="background-image: url('<?php echo e(asset($infos[0]->client->image)); ?>')">
                    <?php if($infos[0]->client->accepte == 1): ?>
          ...
          <div class="card-body">
            ...
            <ul class="nav flex-column side-menu">
              ...
              <li class="nav-item" >
                <div id="permiImg">
                  <img onclick="openImage('<?php echo e(asset($infos[0]->client->permi)); ?>')" src="<?php echo e(asset($infos[0]->client->permi)); ?>" alt="" >
                  <img onclick="openImage('<?php echo e(asset($infos[0]->client->permi)); ?>')" src="<?php echo e(asset($infos[0]->client->permi)); ?>" alt="" >
              </div>
          ...
          <div class="card-body pt-0" style="overflow-x: auto;">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><?php echo e(date('d-m-Y', strtotime($res->date_debut))); ?></td>
                    <td><?php echo e(date('d-m-Y', strtotime($res->date_fin))); ?></td>
                    <td><?php echo e($res->car->marque->name); ?></td>
                    <td><?php echo e($res->car->marque->name); ?></td>
                    <td>
                        <button type="button" class="btn btn-sm btn-success"><?php echo e($res->car->prix_par_jour); ?> DH</button>
                    </td>
                    <?php if($res->accepte == null): ?>
                        <td><span class="badge badge-primary">panding</span></td>
                    <?php elseif($res->accepte == 1): ?>
            ...
            <div class="liksbtns"><?php echo e($reservations->links('pagination::bootstrap-5')); ?></div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/modifiermotdepass">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="id" value="<?php echo e($infos[0]->id); ?>">
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="post" action="/updateinfo" enctype="multipart/form-data">
                      <?php echo csrf_field(); ?>
                      <input type="hidden" name="user_id" value="<?php echo e($infos[0]->id); ?>">
                      <input type="hidden" name="id" value="<?php echo e($infos[0]->client->id); ?>">
                      ...
                      <div class="mb-3">
                          ...
                          <input type="text" name="cin" class="form-control" value="<?php echo e($infos[0]->client->cin); ?>" id="cin" required>
                      </div>

                      <div class="mb-3">
                          <label for="nom" class="form-label">Nom</label>
                          <input type="text" name="nom" class="form-control" value="<?php echo e($infos[0]->client->nom); ?>" id="nom" required>
                      </div>
                      <div class="mb-3">
                          <label for="prenom" class="form-label">Prenom</label>
                          <input type="text" name="prenom" class="form-control" value="<?php echo e($infos[0]->client->prenom); ?>" id="prenom" required>
                      </div>
                      <div class="mb-3">
                          <label for="email" class="form-label">Email</label>
                          <input type="text" name="email" class="form-control"  value="<?php echo e($infos[0]->email); ?>" id="email">
                      </div>
                      <div class="mb-3">
                          <label for="phone" class="form-label">Tele</label>
                          <input type="text" name="phone" class="form-control" value="<?php echo e($infos[0]->client->phone); ?>" id="phone" required>
                      </div>
                      <div class="mb-3">
                          <label for="adresse" class="form-label">Adresse</label>
                          <input type="text" name="adresse" class="form-control" value="<?php echo e($infos[0]->client->adresse); ?>" id="adresse" required>
                      </div>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YouCode\Documents\Mes Projets\fileRouge\Location_Hakimi\resources\views/admin/layout/profileusershow.blade.php ENDPATH**/ ?>