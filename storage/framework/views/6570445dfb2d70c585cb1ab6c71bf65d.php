            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class="active"><a href="<?php echo e(route('Client.cars')); ?>" class="nav-link">Cars</a></li>
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="item-1">
                <a href="#"><img src="assets/Client/images/img_3.jpg" alt="Image" class="img-fluid"></a>
                <div class="item-1-contents">
                  <div class="text-center">
                  <h3><a href="#">Range Rover S64 Coupe</a></h3>
                  <div class="rating">
...
<?php /**PATH C:\xampp\htdocs\Location_Hakimi\resources\views/Client/cars.blade.php ENDPATH**/ ?>