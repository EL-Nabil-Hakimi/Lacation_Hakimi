...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="<?php echo e(route('Client.index')); ?>" class="nav-link">Home</a></li>
    ...
    <div class="ftco-blocks-cover-1">
      <div class="ftco-cover-1 overlay" style="background-image: url('assets/Client/images/hero_1.jpg')">
        <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            ...
            <div class="nonloop-block-13 owl-carousel">
              <div class="item-1">
                <a href="#"><img src="assets/Client/images/img_1.jpg" alt="Image" class="img-fluid"></a>
              ...
              <div class="item-1">
                <a href="#"><img src="assets/Client/images/img_2.jpg" alt="Image" class="img-fluid"></a>
                <div class="item-1-contents">
                  <div class="text-center">
                  <h3><a href="#">Range Rover S64 Coupe</a></h3>
                  <div class="rating">
    ...
    <div class="site-section section-3" style="background-image: url('assets/Client/images/hero_2.jpg');">
      <div class="container">
        <div class="row">
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="assets/Client/images/person_1.jpg" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="assets/Client/images/person_2.jpg" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="assets/Client/images/person_3.jpg" alt="Image" class="img-fluid mr-3">
...
<?php /**PATH C:\xampp\htdocs\Location_Hakimi\resources\views/Client/index.blade.php ENDPATH**/ ?>