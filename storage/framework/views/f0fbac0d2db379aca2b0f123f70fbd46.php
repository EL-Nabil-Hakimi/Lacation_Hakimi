        ...
        <div class="card shadow-sm ">
          ...
          <div class="card-body">
            ...
            <ul class="nav flex-column side-menu">
              ...
              <li class="nav-item" >
                <div id="permiImg">
                  <img onclick="openImage('<?php echo e(asset($user[0]->client->permi)); ?>')" src="<?php echo e(asset($user[0]->client->permi)); ?>" alt="" >
                  <img onclick="openImage('<?php echo e(asset($user[0]->client->permi)); ?>')" src="<?php echo e(asset($user[0]->client->permi)); ?>" alt="" >
              </div>
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="post" action="/updateinfo" enctype="multipart/form-data">
                      ...
                      <input type="hidden" name="id" value="<?php echo e($user[0]->client->id); ?>">
                      ...
                      <div class="mb-3">
                          ...
                          <input type="text" name="cin" class="form-control" value="<?php echo e($user[0]->client->cin); ?>" id="cin" required>
                      </div>

                      <div class="mb-3">
                          <label for="nom" class="form-label">Nom</label>
                          <input type="text" name="nom" class="form-control" value="<?php echo e($user[0]->client->nom); ?>" id="nom" required>
                      </div>
                      <div class="mb-3">
                          <label for="prenom" class="form-label">Prenom</label>
                          <input type="text" name="prenom" class="form-control" value="<?php echo e($user[0]->client->prenom); ?>" id="prenom" required>
                      </div>
                      <div class="mb-3">
                          <label for="email" class="form-label">Email</label>
                          <input type="text" name="email" class="form-control"  value="<?php echo e($user[0]->email); ?>" id="email">
                      </div>
                      <div class="mb-3">
                          <label for="phone" class="form-label">Tele</label>
                          <input type="text" name="phone" class="form-control" value="<?php echo e($user[0]->client->phone); ?>" id="phone" required>
                      </div>
                      <div class="mb-3">
                          <label for="adresse" class="form-label">Adresse</label>
                          <input type="text" name="adresse" class="form-control" value="<?php echo e($user[0]->client->adresse); ?>" id="adresse" required>
                      </div>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YouCode\Documents\Mes Projets\fileRouge\Location_Hakimi\resources\views/admin/layout/profileuser.blade.php ENDPATH**/ ?>