...
<body>
    <div class="email-container">
        <p>Bonjour <?php echo e($user->name); ?>,</p>
        ...
        <a href="<?php echo e(url('changepass/'. $user->remember_token)); ?>">Réinitialiser votre mot de passe</a>
        <br>
        <br>
...
<?php /**PATH C:\Users\YouCode\Documents\Mes Projets\fileRouge\Location_Hakimi\resources\views/Auth/msgemail.blade.php ENDPATH**/ ?>