                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      {{ $user[0]->client->nom }} {{ $user[0]->client->prenom }}
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        {{ $user[0]->client->adresse }}
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Type permi</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                        {{ $user[0]->client->type_permi }}
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Permi</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                        <img src="{{asset($user[0]->client->permi)}}" alt="">
                    </div>
                  </div>
                  <hr>
...
<script>
  ...
  var popupdelclient = function(id){
    Swal.fire({
        icon: "warning",
        title: "Êtes-vous sûr de vouloir bloquer ce client ?",
        ...
        if (result.isConfirmed) {
          window.location.href = "/banclient/" + id;
        }
    });
 }
  var popuprestoreclient = function(id){
    Swal.fire({
        icon: "warning",
        title: "Êtes-vous sûr de vouloir Debloquer ce client ?",
        showCancelButton: true,
        confirmButtonColor: "#d33",
        cancelButtonColor: "#3085d6",
        ...
        if (result.isConfirmed) {
          window.location.href = "/restoreclient/" + id;
        }
    });
 }
